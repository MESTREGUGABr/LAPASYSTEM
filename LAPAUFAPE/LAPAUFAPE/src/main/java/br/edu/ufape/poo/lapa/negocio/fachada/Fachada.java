...
public class Fachada {
	...
	public List<Patologista> procurarTodosOsPatologistas() {
		return cadastroPatologista.procurarTodosOsPatologistas();
	}
	...
	public Patologista procurarPatologistaEmail(String email) {
		return cadastroPatologista.procurarUsuarioPatologistaEmail(email);
	}
